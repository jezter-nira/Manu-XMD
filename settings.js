...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&u63X3bd4' : process.env.SESSION_ID, // put your session id || ඔයාගෙ සෙසන් එක දාන්න...😌❤
...
SUDO: process.env.SUDO === undefined ? '94 74 273 3500' : process.env.SUDO,
